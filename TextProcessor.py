...
class TextProcessor:
    ...
    REFERENCES_STOP_WORDS = set(["reflist","infobox", "refs","em","30em","|","90em","24em","refbegin","refend","cite","author","publisher","ref","title","=","isbn","book","archivedate","archiveurl","accessdate","deadurl","last","first","first1","last1","last2"," ",' ',"  ",'',"aaaaaa","b","aaa"])
    ...
    def process_body_text(self, text):
        ...
        cleanTokens = [t for t in cleanTokens if l(t)==1]
